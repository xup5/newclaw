/**
 * ncl — chat with your NewClaw agent from the terminal.
 *
 * Usage:
 ...
 *
 * Preconditions: NewClaw host service running, an agent group wired to
...
function main(): void {
  ...
  socket.on('error', (err) => {
    ...
    if (e.code === 'ENOENT' || e.code === 'ECONNREFUSED') {
      console.error(`NewClaw daemon not reachable at ${socketPath()}.`);
