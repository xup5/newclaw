/**
 * ncl — chat with your AnotherClaw agent from the terminal.
 *
 * Usage:
 ...
 *
 * Preconditions: AnotherClaw host service running, an agent group wired to
...
function main(): void {
  ...
  socket.on('error', (err) => {
    ...
    if (e.code === 'ENOENT' || e.code === 'ECONNREFUSED') {
      console.error(`AnotherClaw daemon not reachable at ${socketPath()}.`);
