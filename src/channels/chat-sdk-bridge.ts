 ...
 * to conform to the AnotherClaw ChannelAdapter interface.
 *
  ...
  const bridge: ChannelAdapter = {
    ...
    async setup(hostConfig: ChannelSetup) {
      ...
      chat = new Chat({
        ...
        userName: adapter.userName || 'AnotherClaw',
    ...
    if (interaction.type === 2) {
      ...
      if (name && onApplicationCommand) {
        ...
        try {
          ...
          text = 'AnotherClaw failed to handle that command. Check the host logs.';
        }
