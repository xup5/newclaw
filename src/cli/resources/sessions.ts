...
registerResource({
  ...
  table: 'sessions',
  description:
    'Session — the runtime unit. Maps one (agent_group, messaging_group, thread) combination to a runner with its own inbound.db and outbound.db. Created automatically by the router when a message arrives.',
  idColumn: 'id',
  ...
  columns: [
    ...
    },
    {
      ...
      type: 'string',
      description:
        '"running" — runner alive and polling. "stopped" — runner exited; the sweep will restart it automatically when due messages arrive. "idle" — reserved, currently unused.',
